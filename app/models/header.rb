...
class Header < ValueObject
  ...
  class << self
    ...
    def case_headers(user)
      ...
      header_list << CASE_NAME if user.module?(PrimeroModule::POTM) && user.can_list_case_names?
      ...
      header_list << AGE if user.module?(PrimeroModule::POTM)
      header_list << SEX if user.module?(PrimeroModule::POTM)
      header_list << REGISTRATION_DATE if user.module?(PrimeroModule::POTM)
      header_list << CASE_OPENING_DATE if user.module?(PrimeroModule::GBV)
      header_list << PHOTO if user.module?(PrimeroModule::POTM) && user.can?(:view_photo, Child)
    ...
    def incident_headers(user)
      ...
      header_list << DATE_OF_INTERVIEW if user.module?(PrimeroModule::GBV) || user.module?(PrimeroModule::POTM)
      ...
      header_list << CP_DATE_OF_INCIDENT if user.module?(PrimeroModule::POTM)
      header_list << CP_VIOLENCE_TYPE if user.module?(PrimeroModule::POTM)
